...
const UUID = process.env.UUID || 'e16d328e-a8c5-49f6-bc3e-60be24ebe9e9'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'OZMtCS6G39UpEgRvzRNXjS7iDNBRmTsI';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
